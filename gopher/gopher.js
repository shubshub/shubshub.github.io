...
function gopherHelp()
{
	...
	msg[2] = "×: +4 to the char pointer (Unicode &#215;)";
	msg[3] = "÷: -4 from the char pointer (Unicode &#247;)";
	msg[4] = "^: +8 to the char pointer";
	msg[5] = "@: -8 from the char pointer";
	msg[6] = "?: +16 to the char pointer";
	msg[7] = "!: -16 from the char pointer";
	msg[8] = "&: +32 to the char pointer";
	msg[9] = "%: -32 from the char pointer";
	msg[10] = "$: +64 to the char pointer";
	msg[11] = "#: -64 from the char pointer";
	msg[12] = ": : +128 to the char pointer";
	msg[13] = "; : -128 from the char pointer";
	msg[14] = "[: Start a Multiplication loop";
	msg[15] = ",: Sepereate a set of instructions to be multiplied by a number chosen by more instructions";
	msg[16] = "]: End a Multiplication loop";
	msg[17] = "': Double the Pointer Value";
	msg[18] = ".: Halve the pointer Value";
	msg[19] = "<: Push the character onto the stack which is where the char pointer is pointing";
	msg[20] = "=: Output the code to the user";
	msg[21] = "Hello World Example: '&++<'×<&÷+<^-<<×-<#!+<'?^-<?^<×-<÷--<@<.!<=";
